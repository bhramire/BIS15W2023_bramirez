...
```r
RegionSums <- colSums(all_harry_potter_matrix)
RegionSums
```
...
```r
Summed_harry_potter_matrix <- rbind(all_harry_potter_matrix, RegionSums)
Summed_harry_potter_matrix
```
...
## Deathly_Hallows_1     295.9  664.3  960.2
## Deathly_Hallows_2     381.0  960.5 1341.5
## RegionSums           2389.7 5332.9 7722.6
```
