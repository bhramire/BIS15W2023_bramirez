...
```{r}
map2 <- get_map(bbox_griz, maptype = "terrain", source = "stamen")
```
...
```{r}
ggmap(map2) + geom_point(data =grizzly, aes(x=longitude, y= latitude), size =0.4) + labs(title = "Grizzly Bear Sitings", x= "Longitude", y = "Latitude")
```
